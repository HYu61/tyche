...
<input type="hidden" id="apiServer" name="apiServer" value="http://192.168.0.17:8080"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.0.17:8081/bgm_admin"/>
