            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    <a href="<%=request.getContextPath()%>/center.shtml" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <span class="username username-hide-on-mobile">Hello - ${sessionScope.admin.username}</span>
                    </a>
                </li>
                ...
                <li class="dropdown dropdown-quick-sidebar-toggler">
                    <a href="<%=request.getContextPath() %>/admin/logout.action" class="dropdown-toggle">
